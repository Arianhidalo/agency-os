    ...
    <section className="panel rounded-2xl p-5">
      ...
      <div className="mt-4 space-y-3 text-sm">
        ...
        <label className="rounded-xl border border-slate-800 bg-slate-950/70 p-3">
          Language mode
          <select value={settings.languageMode} onChange={(e) => onUpdate({ ...settings, languageMode: e.target.value as AppSettings['languageMode'] })} className="mt-2 w-full rounded-lg border border-slate-700 bg-slate-900/70 p-2">
