...
export function FailureModal({ task, onClose, onSubmit }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/80 p-3 backdrop-blur-sm">
      <form onSubmit={submit} className="panel-strong w-full max-w-2xl rounded-2xl p-5 shadow-2xl">
        ...
        <p className="mt-1 text-sm text-slate-400">Name the enemy. Break the spell.</p>
        ...
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button className="rounded-xl accent-bg-soft accent-border border px-3.5 py-2 font-semibold">Damage contained. Resume mission.</button>
        </div>
      </form>
    </div>
  );
